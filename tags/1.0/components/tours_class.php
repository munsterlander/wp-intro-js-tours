...
if(isset($_POST['frm_tour_addEdit_submit'])){
    ...
    $frmData = array('tour_name'=>sanitize_text_field($_POST['frm_tour_name']),'tour_description'=>sanitize_text_field($_POST['frm_tour_description']),'page_id'=>sanitize_text_field($_POST['frm_tour_page']),'tour_auto_start'=>$autoStart,
        ...
        'hintLabel'=>sanitize_text_field($_POST['frm_hint_buttonLabel']),'hintPosition'=>sanitize_text_field($_POST['frm_hint_position']));
...
function wpintrojs_addEditTour(){
    ...
    echo '<p><label for="frm_tour_name">Tour Name</label><br /><input maxlength="50" type="text" id="frm_tour_name" name="frm_tour_name" required spellcheck="true" autocomplete="off" class="all-options" value="'.$frmName.'"></p>';
    echo '<p><label for="frm_tour_description">Tour Description</label><br /><textarea id="frm_tour_description" name="frm_tour_description" spellcheck="true" autocomplete="off" class="all-options">'.$frmDescription.'</textarea></p>';
