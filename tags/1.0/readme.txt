...
WP Intro.JS plugin allows you to easily add tours or tutorials to your site using [Intro.JS](https://www.introjs.com/).  Additionaly, hint pips are available to be displayed.  Almost every feature within Intro.JS has been implemented.
